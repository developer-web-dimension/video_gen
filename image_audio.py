...
#                                     transition_duration=1.2, fps=30, width=1920, height=1080):
#     """
...
#     print(f"Processing {len(image_files)} images with audio sync")
...
#         # Static phase
#         if i < len(images) - 1:
#             static_frames = max(1, image_frames - transition_frames)
#         else:
...
#     else:        
#         print("🎬 Creating audio-synced enhanced random transition video...")
